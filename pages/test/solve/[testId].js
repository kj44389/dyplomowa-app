...
const Solve = ({ testData, testQuestions, testAnswers, fullName, Email }) => {
	...
	const handleTestStateIncrement = () => {
		...
		if (questions[index + 1].question_time === "00:00:00") {
			nextAvailableIndex = questions.findIndex(
				(question, localIndex) => localIndex > index && question.question_time != "00:00:00"
			);
	...
	return (
		<Layout>
												...
												return (
													<div key={v4()}>
														...
														<Answer
															...
															picked={
																questionsState[
																	questionsState.findIndex(
																		(state) => state.answer_id === answer?.answer.answer_id
																	)
																]?.picked
															}
			...
			{showModal && (
				<div
					className="h-modal fixed top-32 left-1/2 z-50 -translate-x-1/2  items-center justify-center overflow-y-auto overflow-x-hidden sm:h-full "
					id="popup-modal"
				>
						...
						<div className="relative rounded-lg bg-white shadow dark:bg-gray-700">
							...
							<div className="p-6 pt-0 text-center">
								...
								<h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
									During test You can`&apos`t use external help. Please finish your test by yourself or Your
									test will fail.
								</h3>
								<button
									data-modal-toggle="popup-modal"
