...
const Registration = () => {
	...
	const registrationHandler = async () => {
		...
		const response = await _fetch("/api/user/createUser", {
			method: "POST",
	...
	return (
		<div className="w-screen h-screen flex justify-center items-center">
			<div className="flex flex-col max-w-md px-4 py-8 bg-white rounded-lg shadow dark:bg-gray-800 sm:px-6 md:px-8 lg:px-10">
				<div className="self-center mb-6 text-xl font-light text-gray-600 sm:text-2xl dark:text-white">Registration Form</div>
				<div className="mt-8">
