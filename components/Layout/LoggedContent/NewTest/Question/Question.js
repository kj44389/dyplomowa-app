		...
		<div className="indicator mt-16 mb-12 flex h-auto w-full flex-col space-y-6">
			...
			<div className="form-control">
				...
				<select
					...
					defaultValue={question.question_type || "text_one"}
			...
			<div className="flex items-center justify-center">
				...
				{question.question_addon_src !== "" &&
					uploadingStatus !== "pending" &&
					question.question_type == "with_youtube" && <ReactPlayer url={question.question_addon_src} controls />}
			</div>
					...
					{answers
						...
						.map((answer, index) => {
							return (
								<Answer
									key={answer.id}
									props={{ answer: answer, index: index, setanswers: props.setanswers, answers: answers }}
								/>
							);
						})}
				</div>
