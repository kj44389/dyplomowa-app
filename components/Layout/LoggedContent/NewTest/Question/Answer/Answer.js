		...
		<div className="space-y-6">
			...
			<div className="form-control md:space-y-0md:space-x-2  flex w-full flex-col space-y-4 md:flex-row">
				<div className="flex w-full flex-col md:w-1/2">
					...
					<select
						defaultValue={answer.answer_type || "text"}
						className="select select-bordered w-full"
						onChange={(e) => handleAnswerChange("answer_type", e.target.value)}
					>
			...
			<div className="flex items-center justify-center">
				...
				{answer.answer_addon_src !== "" &&
					answer.answer_type == "with_youtube" &&
					uploadingStatus !== "pending" && <ReactPlayer url={answer.answer_addon_src} controls />}
			</div>
			...
			<div className="form-control flex w-full">
				...
				<textarea
					...
					onBlur={(e) => handleAnswerChange("answer_name", e.target.value)}
				></textarea>
			</div>
		</div>
	);
